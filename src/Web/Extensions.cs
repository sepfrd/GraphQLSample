...
public static class Extensions
{
    ...
    {
        public IServiceCollection AddDependencies(IConfiguration configuration, IHostEnvironment environment)
        {
        ...
        private IServiceCollection AddAllGraphQLServices(AppOptions appOptions)
        {
            services
                .AddGraphQLServer()
                .AddFairyBread()
