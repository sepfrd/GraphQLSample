    ...
    : IRequestHandler<UpdateRoleCommand, CommandResult>
{
    public virtual async Task<CommandResult> Handle(UpdateRoleCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogError(message: MessageConstants.MappingFailed, DateTime.UtcNow, typeof(Role), typeof(UpdateRoleCommandHandler));
        ...
        logger.LogError(message: MessageConstants.EntityUpdateFailed, DateTime.UtcNow, typeof(Role), typeof(UpdateRoleCommandHandler));
