...
public sealed class
    GetAllCategoriesQueryHandler : IRequestHandler<GetAllCategoriesQuery, QueryResponse<IEnumerable<Category>>>
{
    ...
    public async Task<QueryResponse<IEnumerable<Category>>> Handle(GetAllCategoriesQuery request,
