...
public class GetPaymentsByUserExternalIdQueryHandler : IRequestHandler<GetPaymentsByUserExternalIdQuery, QueryReferenceResponse<IEnumerable<PaymentDto>>>
{
    ...
    public async Task<QueryReferenceResponse<IEnumerable<PaymentDto>>> Handle(GetPaymentsByUserExternalIdQuery request, CancellationToken cancellationToken)
    {
        ...
        if (user is null)
        {
            return new QueryReferenceResponse<IEnumerable<PaymentDto>>(
                null,
                false,
                Messages.NotFound,
